...
/**
 * Custom CSS
 * @see spa_and_salon_custom_css
*/
add_action( 'wp_head', 'spa_and_salon_custom_css', 100 );
...
function spa_and_salon_scripts() {
    ...
    wp_enqueue_script( 'mcustomscrollbar', get_template_directory_uri(). '/js/jquery.mCustomScrollbar.js', array('jquery'), $version, true  );
	wp_enqueue_script( 'spa-and-salon-js', get_template_directory_uri() . '/js/custom.js', array('jquery'), $version, true );
