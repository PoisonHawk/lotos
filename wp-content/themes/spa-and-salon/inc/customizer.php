...
function spa_and_salon_customize_register( $wp_customize ) {
    ...
    /** Custom CSS*/
    $wp_customize->add_section(
        'spa_and_salon_custom_settings',
        array(
            'title' => esc_html__( 'Custom CSS Settings', 'spa-and-salon' ),
            'priority' => 50,
            'capability' => 'edit_theme_options',
        )
    );
    ...
    $wp_customize->add_setting(
        'spa_and_salon_custom_css',
        array(
            'default' => '',
            'capability'        => 'edit_theme_options',
            'sanitize_callback' => 'spa_and_salon_sanitize_css'
            )
    );
    ...
    $wp_customize->add_control(
        'spa_and_salon_custom_css',
        array(
            'label' => esc_html__( 'Custom Css', 'spa-and-salon' ),
            'section' => 'spa_and_salon_custom_settings',
            'description' => esc_html__( 'Put your custom CSS', 'spa-and-salon' ),
            'type' => 'textarea',
        )
    );
    /** Custom CSS Ends */
...
/**
 * Sanitize Function For CSS.
 */
function spa_and_salon_sanitize_css( $css ){
