	...
	<div class="media-frame-toolbar">
		<div class="media-toolbar">
			...
			<div class="media-toolbar-primary search-form">
				<button type="button" class="button button-primary media-button button-large"><?php esc_html_e( 'Replace Contents With Page Template', PAGE_BUILDER_SANDWICH ) ?></button>
			</div>
		</div>
	</div>
</script>
